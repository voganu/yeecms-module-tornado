 ...
 */
class Prihod extends NgRestModel
{
    use
        //SoftDeleteTrait,
        TagsTrait;
...
//    }
    ...
    {
        return [
            [['prihod_date', 'prihod_summa', 'procent_id', 'postav_id'], 'required'],
            [['prihod_date'], 'date'],
            [['prihod_date', 'prihod_summa', 'procent_id', 'nakl', 'postav_id'], 'safe'],
        ];
    }
